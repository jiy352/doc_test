...
latex_documents = [
    (master_doc, 'atomics.tex', 'atomics Documentation', 'Jiayao Yan',
     'manual'),
]
...
man_pages = [(master_doc, 'atomics', 'atomics Documentation', [author], 1)]
...
texinfo_documents = [
    (master_doc, 'atomics', 'atomics Documentation', author, 'atomics',
